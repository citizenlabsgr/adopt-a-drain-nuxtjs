...
describe('Authorize', () => {
  ...
  it('is good displayname ', async () => {
    wrapper.setData({ aadform: {displayname: 'abc1', name: 'aa.com', password: 'aaaa'} })
  ...
  it('is Disabled ', async () => {
    wrapper.setData({ aadform: {displayname: 'abc', name: 'aa.com', password: 'aaaa'} })
    await wrapper.vm.$nextTick()
    expect(wrapper.vm.isDisabled).toBeTruthy()
  })
  it('is not Disabled ', async () => {
    wrapper.setData({ aadform: {displayname: 'abcd', name: 'a@a.com', password: 'a1A!aaaa'} })
    await wrapper.vm.$nextTick()
